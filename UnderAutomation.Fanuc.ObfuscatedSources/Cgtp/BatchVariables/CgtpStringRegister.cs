...
namespace Cgtp.BatchVariables {
	/// <summary>
	/// Represents a string register (SR[]) for batch read/write operations.
	/// A string register always has a comment and a string value.
	/// </summary>
	public class CgtpStringRegister : StringRegisterWithComment, ICgtpBatchVariable {
