...
namespace Rmi.TpInstructions {
	/// <summary>
	/// Instruction for an incremental linear motion (L in TP), Cartesian delta representation.
	...
	/// </summary>
	public class LinearRelativeTpInstruction : CartesianMotionTpInstructionBase {


		public LinearRelativeTpInstruction()
		{
