...
namespace Rmi.TpInstructions {
	/// <summary>
	/// Instruction for an incremental linear motion (L in TP), joint-angle representation.
	...
	/// </summary>
	public class LinearRelativeJRepTpInstruction : JRepMotionTpInstructionBase {


		public LinearRelativeJRepTpInstruction()
		{
