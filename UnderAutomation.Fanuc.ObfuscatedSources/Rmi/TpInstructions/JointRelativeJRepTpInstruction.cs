...
namespace Rmi.TpInstructions {
	/// <summary>
	/// Instruction for an incremental joint motion (J in TP), joint-angle representation, full options.
	...
	/// </summary>
	public class JointRelativeJRepTpInstruction : JRepMotionTpInstructionBase {


		public JointRelativeJRepTpInstruction()
		{
