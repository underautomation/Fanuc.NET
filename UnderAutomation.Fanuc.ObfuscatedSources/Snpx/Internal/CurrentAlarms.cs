...
namespace Snpx.Internal {
	...
	public class CurrentAlarms : SnpxAssignableElements<RobotAlarm, CurrentAlarmsRequest> {
		...
		protected override string GetAssignmentTarget(CurrentAlarmsRequest index)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RobotAlarm ReadHistory(int index)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
		...
		public RobotAlarm ReadLastAlarm(int index)
		{
			// Source is hidden, a Source licence is needed to access internal code...
			return default;
		}
