...
namespace Common.Files.Variables {
	...
	/// </summary>
	public class ErNoalmVariableType : GenericVariableType, IGenericVariableType {


		public ErNoalmVariableType()
		{
